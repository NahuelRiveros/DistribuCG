...
export const navbar_config = {
  ...
  links: [
    ...
    { label: "Ingreso",      to: "/kiosk",               requiereAuth: true, roles: ["admin", "staff"], modulo: "gym", icon: ScanLine },
    ...
    { label: "Registro",     to: "/register",            requiereAuth: true, roles: ["admin", "staff"], icon: UserPlus },
    {
      ...
      items: [
        {
          ...
          children: [
            ...
            { label: "Ventas",                to: "/admin/ventas",              requiereAuth: true, roles: ["admin", "staff"], modulo: "gym", icon: ShoppingCart },
        ...
        },
        {
          ...
          roles: ["admin", "staff"],
          children: [
            { label: "Volumen de avisos", to: "/admin/config-audio", requiereAuth: true, roles: ["admin", "staff"], icon: Volume2 },
