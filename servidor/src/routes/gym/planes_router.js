...
planesRouter.get("/",    requireAuth, requireRole("admin", "staff", "profesional"), listarPlanesController);
planesRouter.get("/:id", requireAuth, requireRole("admin", "staff", "profesional"), obtenerPlanPorIdController);
